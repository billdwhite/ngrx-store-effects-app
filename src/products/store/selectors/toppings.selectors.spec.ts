...
describe("Toppings Selectors", () => {
    ...
    beforeEach(() => {
        ...
        spyOn(store, "dispatch").and.callThrough(); // spy but do not alter function
    });

    describe("getToppingEntities", () => {
        it("should return toppings as entities", () => {
            let result; // declare here so we can check it to confirm tests
            store
